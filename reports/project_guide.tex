...
content\_score  & Encoded operational indicator used by the original project \\
price\_score  & Encoded operational indicator used by the original project \\
profile\_score & Encoded operational indicator used by the original project \\
...
\section{Complete bibliography inherited from the original thesis}
The original thesis contains a bibliography than could reasonably be cited in the body of every articles. The complete bibliography inherited from the thesis is reproduced below. It preserves the original documentary basis while every article uses a tighter, argument-driven set of cited references.
