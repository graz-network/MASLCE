...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{../figures/workflow_overview.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.80\textwidth]{../figures/roc_curves.png}
